...
```
  ...
  Answer: The estimated standard errors for the coefficients associated with income and balance is 4.985e-06 and 2.274e-04.
...
```
  ...
  Answer : The boot.fn function return the coefficient value of the income and balance  2.080898e-05 and 5.647103e-03.
...
```
  ...
  Answer : Finding the Glm function for the variable Lag1 and Lag2  
